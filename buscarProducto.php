            ...
            <div>
                <form method='post' action='buscarProducto.php'>
                    <center><table border='0'style='background-color: white;'>
                            <tr>
                                <td>Codigo o Nombre del producto</td>
                            <input type="text" name="txtBus"><br>
                            <td><input type="submit" name="btnCod" value="Codigo">
                                <input type="submit" name="btnNom" value="Nombre">
                                <?php
                                if (!empty($_POST["txtBus"])) {

                                    if (isset($_POST['btnCod'])) {
                                        for ($i = 0; $i < count($codigoProducto); $i++) {
                                            if ($_POST["txtBus"] == $codigoProducto[$i]) {
                                                $encontro = true;
                                                $pos = $i;
                                            } else {
                                    ...
                                    if (isset($_POST['btnNom'])) {
                                        for ($i = 0; $i < count($nombreProducto); $i++) {
                                            if ($_POST["txtBus"] == $nombreProducto[$i]) {
                                                $encontro = true;
                                                $pos = $i;
                                            } else {
                                                $mensaje = "El producto no esta registrado";
